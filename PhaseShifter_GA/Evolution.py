...
def Evolution(Chromosome):

    randomstate = random.randint(0,63);
    sequence = [-1, 1];
    BitChange = random.choice(sequence); 

    GodNumber = random.randint(0,6);
    if GodNumber==0:
        Chromosome.StateList[randomstate].StateBitA = random.randint(0,7)
        Chromosome.StateList[randomstate].StateBitB = random.randint(0,7)
    elif GodNumber==1:
        Chromosome.StateList[randomstate].StateBitA = random.randint(0,7)
    elif GodNumber==2:
